@testset "distributions" begin
    ...
    multivariate_distributions = DistSpec[
        ...
        DistSpec(s -> MvNormal(Diagonal(Fill(s^2, dim))), (alpha,), a),
        ...
        DistSpec(s -> TuringMvNormal(Diagonal(Fill(s^2, dim))), (alpha,), a),
        ...
        DistSpec(s -> MvLogNormal(Diagonal(Fill(s^2, dim))), (alpha,), a, to_positive),
    ...
    broken_multivariate_distributions = DistSpec[
        ...
        DistSpec(p -> MvNormalCanon(Diagonal(Fill(p^2, dim))), (alpha,), a),
        DistSpec((m, A) -> MvNormalCanon(m, to_posdef(A)), (a, A), B),
