...
multi_cont_dists = [
    ...
    DistSpec(:TuringMvNormal, (mean, cov_mat), norm_val_vec),
    DistSpec(:TuringMvNormal, (mean, cov_vec), norm_val_vec),
    DistSpec(:TuringMvNormal, (mean, Diagonal(cov_vec)), norm_val_vec),
    DistSpec(:TuringMvNormal, (mean, cov_num), norm_val_vec),
    DistSpec(:((m, v) -> TuringMvNormal(m, v*I)), (mean, cov_num), norm_val_vec),
    ...
    DistSpec(:(cov_num -> TuringMvNormal(dim, cov_num)), (cov_num,), norm_val_vec),
...
matrix_cont_dists = [
    ...
    #DistSpec(:TuringWishart, (dim, cov_mat), cov_mat),
    #DistSpec(:TuringInverseWishart, (dim, cov_mat), cov_mat),
    # Vector of matrices x
    DistSpec(:((n1, n2)->MatrixBeta(dim, n1, n2)), (dim, dim), fill(beta_mat, 2)),
    DistSpec(:Wishart, (dim, cov_mat), fill(cov_mat, 2)),
    DistSpec(:InverseWishart, (dim, cov_mat), fill(cov_mat, 2)),
    #DistSpec(:TuringWishart, (dim, cov_mat), fill(cov_mat, 2)),
